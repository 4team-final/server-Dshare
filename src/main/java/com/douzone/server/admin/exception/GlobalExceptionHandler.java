...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({MissMatchEndPointException.class})
    public ResponseEntity<ErrorResponseDTO> MissMatchEndPointException(MissMatchEndPointException e) {
        log.error("MissMatchEndPointException : ", e.getMessage());
