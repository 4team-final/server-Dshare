...
public class AdminController {
    ...
    public ResponseEntity<ResponseDTO> uploadProfileImg(@NotNull MultipartFile file) {
        return ResponseEntity.ok().body(ResponseDTO.of(HttpStatus.OK, Message.SUCCESS_ADMIN_REGISTER, adminService.uploadProfileImg(file)));
    }
